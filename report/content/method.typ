...
#let prototype = [
The proposed prototype selected for development is Concept 3, which incorporates a modular table, data collection system, PID control loop, preheat barrier, and thermocouples. The physical design can be seen in @table, and uses accurate measurements as well as available CAD data. The wiring diagram shown in @wiring provides a rough overview of how each component is being powered, and which components require control signals. @data is a data processing diagram, showing how the captured data is parsed and collated into usable forms.

#figure(image("table.png", width: 85%), caption: [Prototype CAD Model.]) <table>

#figure(image("circuit-diagram.png"), caption: [Electrical Wiring Diagram.]) <wiring>
...
#figure(image("data.png", width: 70%), caption: [Data Processing Diagram.]) <data>
...
#let timeline = [
- October 8-14: Complete first draft of chapters 1-3
- October 14-21: Finish draft for the budget and bill of materials. Additionally, establish space requirements and a project management schedule.
- October 22-28: Finalize supplier list, bill of materials, and management timeline.
- October 29-November 4: Review all work and make any changes needed. Contact Ben and ensure that he’s on the same page as the team with the project plans for the second semester.
- November 5-11: Create presentation slides and prepare for presentation.
- November 12-18: Presentations and presentation of peer review.
- November 19-25: Review suggested changes, update project proposal, submit materials order with approval from Dr. Awad.
- November 26-December 10: Finalize all work and submit the final version of the completed proposal. If all work is completed before the deadline, begin to create a general plan for the next semester/building phase.
] 
